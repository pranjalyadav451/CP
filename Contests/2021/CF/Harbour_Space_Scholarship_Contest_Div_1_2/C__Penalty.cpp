...
int mn = 1e7;
int rec(string &S, int A  = 0 , int B = 0 , int i  = 0) {
	if (i >= 10) {
		return 10;
	}
	...
	if (i % 2 == 0) {
		if (S[i] == '1') {
			return rec(S, A + 1, B, i + 1);
		}
		else if (S[i] == '0') {
			return rec(S, A , B , i + 1);
		}
		else {
			return min(rec(S, A , B , i + 1), rec(S , A + 1, B , i + 1));
		}
	}
	else {
		if (S[i] == '1') {
			return rec(S, A , B + 1, i + 1);
		}
		else if (S[i] == '0') {
			return rec(S, A , B , i + 1);
		}
		else {
			return min(rec(S, A , B , i + 1), rec(S , A, B + 1 , i + 1));
		}
	}
